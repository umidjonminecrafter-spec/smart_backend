...
from .views import GlobalAttendanceAPIView, AttendanceAnalyticsAPIView, UnmarkedGroupsAPIView, BranchStatusAPIView,SalesFunnelView
...
urlpatterns = [
    ...
    path('reports/sales-funnel/', SalesFunnelView.as_view(), name='sales-funnel-report'),
]