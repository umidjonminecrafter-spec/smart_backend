...
from .views import GlobalAttendanceAPIView, AttendanceAnalyticsAPIView, UnmarkedGroupsAPIView, BranchStatusAPIView, DBDebugAPIView
...
urlpatterns = [
    ...
    path('db-debug/', DBDebugAPIView.as_view(), name='db-debug'),
]