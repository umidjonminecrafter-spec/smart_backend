    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_bot_token', models.CharField(blank=True, max_length=255, null=True)),
                ('verification_bot_username', models.CharField(blank=True, max_length=255, null=True)),
                ('student_bot_token', models.CharField(blank=True, max_length=255, null=True)),
                ('student_bot_username', models.CharField(blank=True, max_length=255, null=True)),
                ('parent_bot_token', models.CharField(blank=True, max_length=255, null=True)),
                ('parent_bot_username', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_bot_token', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_bot_username', models.CharField(blank=True, max_length=255, null=True)),
                ('is_active', models.BooleanField(default=False)),
